...
_These are helper scripts to facilitate various CLI jobs in this Project._

* #### `SF_deployer`: SourceForge deployer

  _This script auto-deploys CLI compiled Cross & Native GCC Toolchain binaries to SourceForge secured servers._
