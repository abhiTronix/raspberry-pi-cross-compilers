...
* **Obsolete Binaries(limited support)**
  * GCC 8.2.0
  * GCC 7.4.0
* **Latest Releases(full functionality)**
  * GCC 6.3.0 (*Cross-Compiler binaries only*)
  * GCC 8.3.0
...
The original compiled GCC files source code is licensed under the [**GNU v3.0**](https://www.gnu.org/licenses/gpl-3.0.en.html) license. However, This Project is licensed under the **Apache 2.0** license. See the [LICENSE](https://github.com/abhiTronix/raspberry-pi-cross-compilers/blob/master/LICENSE) file for the full license text.
&nbsp; 
 
## Acknowledgment
- https://gcc.gnu.org/ for providing latest source code.   
- https://www.raspberrypi.org/ for providing latest kernel and docs.  
- https://sourceforge.net for allowing me to publish these binaries.
- http://preshing.com/20141119/how-to-build-a-gcc-cross-compiler/ for inspiring tutorial.   
